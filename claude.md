...
- **오늘의 운세 v4.0 (PRD v4.0 Group 4 Task 12-15)**
  - Python 파이프라인 10단계 → 14단계 확장
  - Task 12: 형/파/해/원진 감지 (부정적 상호작용 -7~-15점)
  - Task 13: 12신살 감지 (길신/흉신 판단 ±10~15점)
  - Task 14: 물상론 DB 적용 (십신별 사건 키워드 프롬프트)
  - Task 15: 조후 튜닝 워드 (계절 기후 개인화 +12점)
  - 점수 공식 확장: `(base + bonus + penalty - 50) × modifier + 50`
  - `_analysis_meta` 응답 필드 확장 (Task 12-15 정보)
- **문서 업데이트**
  - `docs/daily_analysis.md` v4.0 (14단계 파이프라인)
  - `docs/PRDv4.md` Task 12-15 완료 체크

### v1.44.0 (2026-01-12)
- **오늘의 운세 고도화 (PRD v4.0 Group 4 Task 7-11)**
  - Python 파이프라인 3단계 → 10단계 확장
  - Task 7: 12운성 점수 반영 (±6점, 운세 설명 다국어)
  - Task 8: 복음/반음 감지 (사건 반복 ×1.4, 급변 ×1.7)
  - Task 9: 조후용신 적용 (궁통보감 계절별 +10점)
  - Task 10: 삼합/방합 국 형성 (영역별 +8~+15점)
  - Task 11: 용신 기반 행운 정보 개인화 (+15점)
  - 점수 공식: `(base + bonus - 50) × modifier + 50`
  - `_analysis_meta` 응답 필드 추가
  - 다국어 메시지 5개 언어 지원
- **문서 업데이트**
  - `docs/daily_analysis.md` v2.0 (10단계 파이프라인)
