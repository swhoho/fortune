...
| Task | 파일 |
|------|------|
| 2.1 Report 탭/섹션 | `src/components/report/ReportNavigation.tsx`, `PersonalitySection.tsx`, `DaewunDetailSection.tsx`, `RomanceSection.tsx`, `AptitudeSection.tsx` |
| 2.2 Yearly 섹션 | `src/components/analysis/yearly/YearlyAdviceCard.tsx` |
