...
export function DaewunHorizontalScroll({
  ...
  return (
    ...
    >
      ...
      {/* 좌측 그라데이션 */}
      <div className="pointer-events-none absolute left-10 top-0 z-[5] h-full w-8 bg-gradient-to-r from-[#0a0a0a] to-transparent" />

      {/* 우측 그라데이션 */}
      <div className="pointer-events-none absolute right-10 top-0 z-[5] h-full w-8 bg-gradient-to-l from-[#0a0a0a] to-transparent" />

      {/* 스크롤 컨테이너 */}
      <div
        ref={scrollRef}
        className="scrollbar-hide flex snap-x snap-mandatory gap-3 overflow-x-auto px-14 py-4"
