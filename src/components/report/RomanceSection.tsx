...
const ROMANCE_TRAIT_DESCRIPTIONS: TraitDescription[] = [
  {
    ...
    medium: '상대방을 배려하는 마음과 자신의 필요 사이에서 균형을 잡으려 합니다. 상황에 따라 배려심을 발휘하지만, 때로는 자기 중심적인 면도 있어 일관성 있는 배려가 필요합니다.',
  ...
  },
  {
    ...
    medium: '상황에 맞게 유머를 구사하며, 적절한 타이밍에 분위기를 밝게 만들 수 있습니다. 너무 가볍지도, 너무 무겁지도 않은 대화 스타일로 균형 잡힌 소통이 가능합니다.',
  ...
  },
  {
    ...
    medium: '적당한 감성과 현실 감각을 겸비하고 있습니다. 특별한 날에는 로맨틱한 분위기를 연출하기도 하며, 일상에서는 실용적인 면을 보여줍니다.',
  ...
  },
  {
    ...
    medium: '적절한 자기 표현과 겸손함 사이에서 균형을 유지합니다. 때로는 좋은 인상을 주기 위해 노력하지만, 과도한 과시는 피하려 합니다.',
  ...
  },
  {
    ...
    medium: '새로운 경험과 안정 사이에서 균형을 찾습니다. 가끔은 새로운 도전을 즐기지만, 기본적으로는 안정적인 관계를 원합니다.',
  ...
  },
  {
    ...
    medium: '기본적인 약속은 잘 지키지만, 때로는 상황에 따라 유연하게 대처합니다. 중요한 일에는 성실하게 임하지만, 모든 면에서 완벽하지는 않습니다.',
  ...
  },
  {
    ...
    medium: '상황에 맞게 사회적 활동에 참여하며, 적당한 수준의 사교 활동을 유지합니다. 필요할 때는 외향적으로, 때로는 조용히 둘만의 시간을 즐깁니다.',
  ...
  },
  {
    ...
    medium: '적당한 저축과 소비 사이에서 균형을 유지합니다. 미래를 위한 준비도 하면서 현재의 데이트 비용도 합리적으로 관리하려 합니다.',
  ...
  },
  {
    ...
    medium: '대체로 믿을 수 있는 모습을 보이지만, 가끔 예상치 못한 행동을 하기도 합니다. 중요한 약속은 잘 지키려 노력하며, 신뢰를 쌓아가고 있습니다.',
  ...
  },
  {
    ...
    medium: '상황에 따라 감정을 표현하지만, 항상 적극적이지는 않습니다. 중요한 순간에는 마음을 전달하려 노력하며, 점차 표현력을 키워가고 있습니다.',
