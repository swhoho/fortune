          ...
          <div className="space-y-8 text-sm leading-relaxed text-gray-300">
            ...
            <section>
              ...
              <ul className="list-inside list-disc space-y-2">
                ...
                <li>
                  <strong className="text-white">회원 관리:</strong> 회원제 서비스 이용, 본인
                  확인, 부정 이용 방지
                </li>
                <li>
                ...
                <li>
                  <strong className="text-white">서비스 개선:</strong> 신규 기능 개발, 서비스
                  품질 향상
                </li>
                <li>
            ...
            <section>
              ...
              <p className="mb-3">
                회사는 원활한 서비스 제공을 위해 다음과 같이 개인정보 처리 업무를 위탁하고
                있습니다:
              </p>
            ...
            <section>
              ...
              <p className="mt-3 text-gray-400">
                위 권리 행사는 이메일(asolid@gmail.com)을 통해 요청하실 수 있으며,
                회사는 지체 없이 조치하겠습니다.
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="list-inside list-decimal space-y-2">
                <li>
                  <strong className="text-white">파기 절차:</strong> 이용자의 개인정보는 목적
                  달성 후 별도의 DB에 옮겨져 내부 방침 및 관련 법령에 따라 일정 기간 저장된 후
                  파기됩니다.
                </li>
                <li>
            ...
            <section>
              ...
              <p className="mb-3">
                이용자는 개인정보침해로 인한 피해를 구제받기 위해 아래 기관에 분쟁 해결이나
                상담을 신청할 수 있습니다:
              </p>
              <ul className="list-inside list-disc space-y-2 text-gray-400">
